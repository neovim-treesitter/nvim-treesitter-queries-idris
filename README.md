# nvim-treesitter-queries-idris

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-idris/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-idris/actions/workflows/validate.yml)

Neovim tree-sitter queries for **idris**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-idris",
...
- [ ] Changes are scoped to `idris` — do not include files for other languages
